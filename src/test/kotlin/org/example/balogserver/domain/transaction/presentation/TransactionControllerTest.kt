...
class TransactionControllerTest {
    ...
    fun createTransactionReturnsCreated() {
        ...
        Mockito.verify(createTransactionService).execute(org.example.balogserver.domain.transaction.presentation.dto.CreateTransactionRequest(Transaction.TransactionType.EXPENSE, 4500, "스타벅스 강남점", Category.FOOD, LocalDate.of(2026, 8, 12)))
    }
    ...
    fun updateTransactionCategoryReturnsUpdatedTransaction() {
        ...
        val request = org.example.balogserver.domain.transaction.presentation.dto.UpdateTransactionCategoryRequest(Category.CAFE_SNACK)
